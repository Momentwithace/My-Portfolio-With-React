...
const Contact = () => {
  return (
    ...
    ">
        ...
        <div 
        className="fles flex-col p-4 justify-center max-w-screen-lg mx-auto
        h-full">
            <div className="pb-8">
                <p className="txet-4xl font-bold inline border-b-4 border-gray-500">
                    Contact
                    </p>
                <p className="py-6">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/9ee50519-c67a-45af-b5b0-4cba59a487dc"
                method="POST"
